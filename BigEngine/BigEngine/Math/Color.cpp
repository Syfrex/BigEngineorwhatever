...
const Big::Color Big::Color::Transparent(1.0f, 1.0f, 1.0f, 0.0f);
const Big::Color Big::Color::Magenta(1.0f, 0.0f, 1.0f, 1.0f);
const Big::Color Big::Color::Blue(0.0f, 0.0f, 1.0f, 1.0f);
const Big::Color Big::Color::Green(0.0f, 1.0f, 0.0f, 1.0f);
const Big::Color Big::Color::Yellow(0.0f, 1.0f, 1.0f, 1.0f);
